...
const Hero = () => {
  ...
  const slides = [
    {
      image: "https://img.freepik.com/free-photo/three-students-studying-doing-homework-together_1262-15319.jpg",
      title: "Explore Gigs",
      description: "Find part-time opportunities designed for students.",
    },
    {
      image: "https://img.freepik.com/free-photo/cheerful-students-posing-table_23-2147656326.jpg",
      title: "Explore Gigs",
      description: " Find part-time opportunities designed for students ",
    }
  ]
